...
listObject:addItem({icon = "<#icon.png#>", width = "<#number#>", height = "<#number#>"  }, "<#mainTitle#>", "<#subTitle#>", <#onTouch#>, <#hideArrowBOOL#>, <#isCategoryBOOL#>, "<#categoryBgImg#>", <#categoryHeight#>, <#categoryTextR#>, <#categoryTextG#>, <#categoryTextB#>)
removeItem(<#row#>)
removeAllItems()
printItems()
clearSelection()
